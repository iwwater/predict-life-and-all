...
- **覆盖**: **19 大术数** — 八字、紫微、奇门、六爻、蓍草筮法、梅花、称骨、八宅、玄空飞星、合盘、西方占星、吠陀占星、塔罗、数字命理、大六壬、小六壬、铁板神数、雷诺曼
- **现实条件引擎**: 现金/合同/搬迁/健康/资质/家庭/备选 7 维现实约束校正（方案 §十四）
- **时辰校正**: 4 精度模式 + 候选排名 + 历史事件验证 + 追问建议
- **古籍知识库**: 古典规则（渊海子平/滴天髓等）+ 推荐书单（9 术法各 3-6 本典籍）
- **罗盘采集**: `/compass` 页面 + 24 山 API + 连续采样

> 免责声明:本平台为传统文化与自我反思工具,所有解读**非科学预测**,不构成医疗 / 法律 / 财务 / 投资建议。涉及健康、法律、投资的决定请咨询专业人士。系统含时辰校正、罗盘采集、古籍推荐功能。
