  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="relative" style={{ width: size, height: size }}>
        ...
        >
          {/* 外圈虚线 */}
          <circle cx={cx} cy={cy} r={r + 4} fill="none" stroke="var(--gold-dim)" strokeWidth="0.5" strokeDasharray="2 4" className="spin-slow" />
          <circle cx={cx} cy={cy} r={r} fill="none" stroke="var(--line)" strokeWidth="1" />
          <circle cx={cx} cy={cy} r={r * 0.85} fill="none" stroke="var(--line-soft)" strokeWidth="0.5" />
          <circle cx={cx} cy={cy} r={innerR} fill="none" stroke="var(--line-soft)" strokeWidth="0.5" />
          <circle cx={cx} cy={cy} r={innerR * 0.55} fill="var(--bg-deep)" stroke="var(--line)" strokeWidth="0.5" />
          ...
          {show24 && Array.from({ length: 24 }).map((_, i) => {
            ...
            return <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke="var(--line)" strokeWidth="0.5" opacity={i % 3 === 0 ? 1 : 0.4} />;
          })}
            ...
            return (
              ...
              >
                <path
                  ...
                  stroke={isSelected ? COLOR.gold : isActive ? "var(--line)" : "var(--line-soft)"}
                ...
                {show24 && (
                  <text
                    ...
                    textAnchor="middle" dominantBaseline="middle"
                    fontSize={9}
                    fill={isActive ? COLOR.goldDim : "var(--muted)"}
      ...
      {/* 选中方位的白话提示 */}
      <div className="text-xs text-center max-w-xs reveal-up" key={activeDir.code} style={{ color: COLOR.inkSoft }}>
